              ...
              <div id="GoToCheckout" className="md:w-[33%] absolute top-0 right-0 m-2">
                  <ClientOnly>
                      <div className="bg-white p-4 border">
                          ...
                          <Link
                            href="/checkout"
                            className="flex items-center justify-center bg-orange-600 hover:bg-orange-700 w-full text-white text-[16px] font-semibold p-3 rounded-full mt-4 transition-colors"
                          >
                            Go to checkout
                          </Link>
